...
\mbox{\hyperlink{namespace_prophecy}{Prophecy}} is a highly opinionated yet very powerful and flexible PHP object mocking framework. Though initially it was created to fulfil phpspec2 needs, it is flexible enough to be used inside any testing framework out there with minimal effort.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md410}{}\doxysection{A simple example}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md410}
...
\end{DoxyCode}
\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md411}{}\doxysection{Installation}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md411}
\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md412}{}\doxysubsection{Prerequisites}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md412}
\mbox{\hyperlink{namespace_prophecy}{Prophecy}} requires PHP 7.\+2.\+0 or greater.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md413}{}\doxysubsection{Setup through composer}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md413}
...
You can read more about \mbox{\hyperlink{namespace_composer}{Composer}} on its \href{http://getcomposer.org}{\texttt{ official webpage}}.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md414}{}\doxysection{How to use it}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md414}
...
There are 2 interesting calls -\/ {\ttfamily will\+Extend} and {\ttfamily will\+Implement}. The first one tells object prophecy that our object should extend a specific class. The second one says that it should implement some interface. Obviously, objects in PHP can implement multiple interfaces, but extend only one parent class.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md415}{}\doxysubsection{Dummies}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md415}
...
You need to understand one thing -\/ a dummy is not a prophecy. Your object prophecy is still assigned to {\ttfamily \$prophecy} variable and in order to manipulate with your expectations, you should work with it. {\ttfamily \$dummy} is a dummy -\/ a simple php object that tries to fulfil your prophecy.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md416}{}\doxysubsection{Stubs}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md416}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\$prophecy-\/>read(\textcolor{stringliteral}{'123'})-\/>will(\textcolor{keyword}{new} \mbox{\hyperlink{namespace_prophecy}{Prophecy}}\(\backslash\)Promise\(\backslash\)ReturnPromise(array(\textcolor{stringliteral}{'value'})));}
...
Keep in mind, that you can always add even more promises by implementing {\ttfamily \mbox{\hyperlink{namespace_prophecy}{Prophecy}}\textbackslash{}Promise\textbackslash{}Promise\+Interface}.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md418}{}\doxysubsubsection{Method prophecies idempotency}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md418}
...
That\textquotesingle{}s interesting, right? Now you might ask me how would you define more complex behaviors where some method call changes behavior of others. In \mbox{\hyperlink{namespace_p_h_p_unit}{PHPUnit}} or Mockery you do that by predicting how many times your method will be called. In \mbox{\hyperlink{namespace_prophecy}{Prophecy}}, you\textquotesingle{}ll use promises for that\+:
...
\DoxyCodeLine{\$user-\/>setName(\textcolor{stringliteral}{'everzet'})-\/>will(\textcolor{keyword}{function} (\mbox{\hyperlink{_array_declaration_unit_test_81_8inc_a67e94494731d99ed23b123e95175bc10}{\$args}}, \$user) \{}
\DoxyCodeLine{    \$user-\/>getName()-\/>willReturn(\textcolor{stringliteral}{'everzet'});}
\DoxyCodeLine{\});}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Or}}
\DoxyCodeLine{\$user-\/>setName(\textcolor{stringliteral}{'everzet'})-\/>will(\textcolor{keyword}{function} (\mbox{\hyperlink{_array_declaration_unit_test_81_8inc_a67e94494731d99ed23b123e95175bc10}{\$args}}) use (\$user) \{}
\DoxyCodeLine{    \$user-\/>getName()-\/>willReturn(\textcolor{stringliteral}{'everzet'});}
\DoxyCodeLine{\});}
...
This feature is actually not recommended for most cases. Relying on the order of calls for the same arguments tends to make test fragile, as adding one more call can break everything.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md419}{}\doxysubsubsection{Arguments wildcarding}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md419}
...
You see, even if method arguments used during method prophecy creation look like simple method arguments, in reality they are not. They are argument token wildcards. As a matter of fact, `-\/\texorpdfstring{$>$}{>}set\+Name(\textquotesingle{}everzet')\`{} looks like a simple call just because \mbox{\hyperlink{namespace_prophecy}{Prophecy}} automatically transforms it under the hood into\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{\$user-\/>setName(\textcolor{keyword}{new} \mbox{\hyperlink{namespace_prophecy}{Prophecy}}\(\backslash\)Argument\(\backslash\)Token\(\backslash\)ExactValueToken(\textcolor{stringliteral}{'everzet'}));}

\end{DoxyCode}


Those argument tokens are simple PHP classes, that implement {\ttfamily \mbox{\hyperlink{namespace_prophecy}{Prophecy}}\textbackslash{}Argument\textbackslash{}Token\textbackslash{}Token\+Interface} and tell \mbox{\hyperlink{namespace_prophecy}{Prophecy}} how to compare real arguments with your expectations. And yes, those classnames are damn big. That\textquotesingle{}s why there\textquotesingle{}s a shortcut class {\ttfamily \mbox{\hyperlink{namespace_prophecy}{Prophecy}}\textbackslash{}Argument}, which you can use to create tokens like that\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{use \mbox{\hyperlink{namespace_prophecy_1_1_argument}{Prophecy\(\backslash\)Argument}};}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// For PHP 5.4}}
\DoxyCodeLine{\$user-\/>setName(Argument::type(\textcolor{stringliteral}{'string'}))-\/>will(\textcolor{keyword}{function} (\mbox{\hyperlink{_array_declaration_unit_test_81_8inc_a67e94494731d99ed23b123e95175bc10}{\$args}}) \{}
\DoxyCodeLine{    \$this-\/>getName()-\/>willReturn(\mbox{\hyperlink{_array_declaration_unit_test_81_8inc_a67e94494731d99ed23b123e95175bc10}{\$args}}[0]);}
\DoxyCodeLine{\});}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// For PHP 5.3}}
\DoxyCodeLine{\$user-\/>setName(Argument::type(\textcolor{stringliteral}{'string'}))-\/>will(\textcolor{keyword}{function} (\mbox{\hyperlink{_array_declaration_unit_test_81_8inc_a67e94494731d99ed23b123e95175bc10}{\$args}}, \$user) \{}
\DoxyCodeLine{    \$user-\/>getName()-\/>willReturn(\mbox{\hyperlink{_array_declaration_unit_test_81_8inc_a67e94494731d99ed23b123e95175bc10}{\$args}}[0]);}
\DoxyCodeLine{\});}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Or}}
\DoxyCodeLine{\$user-\/>setName(Argument::type(\textcolor{stringliteral}{'string'}))-\/>will(\textcolor{keyword}{function} (\mbox{\hyperlink{_array_declaration_unit_test_81_8inc_a67e94494731d99ed23b123e95175bc10}{\$args}}) use (\$user) \{}
\DoxyCodeLine{    \$user-\/>getName()-\/>willReturn(\mbox{\hyperlink{_array_declaration_unit_test_81_8inc_a67e94494731d99ed23b123e95175bc10}{\$args}}[0]);}
\DoxyCodeLine{\});}
...
\end{DoxyCode}
\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md422}{}\doxysubsubsection{Predictions}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md422}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\$entityManager-\/>flush()-\/>should(\textcolor{keyword}{new} \mbox{\hyperlink{namespace_prophecy}{Prophecy}}\(\backslash\)Prediction\(\backslash\)CallPrediction());}
...
In \mbox{\hyperlink{namespace_p_h_p_unit}{PHPUnit}}, you would want to put this call into the {\ttfamily tear\+Down()} method. If no predictions are defined, it would do nothing. So it won\textquotesingle{}t harm to call it after every test.
...
Of course, you can always create your own custom prediction any time by implementing {\ttfamily Prediction\+Interface}.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md423}{}\doxysubsection{Spies}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md423}
...
Such manipulation with doubles is called spying. And with \mbox{\hyperlink{namespace_prophecy}{Prophecy}} it just works.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md424}{}\doxysection{FAQ}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md424}
\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md425}{}\doxysubsection{Can I call the original methods on a prophesized class?}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpspec_prophecy__r_e_a_d_m_e_autotoc_md425}
\mbox{\hyperlink{namespace_prophecy}{Prophecy}} does not support calling the original methods on a phrophesized class. If you find yourself needing to mock some methods of a class while calling the original version of other methods, it\textquotesingle{}s likely a sign that your class violates the \href{https://en.wikipedia.org/wiki/Single-responsibility_principle}{\texttt{ single-\/responsibility principle}} and should be refactored. 