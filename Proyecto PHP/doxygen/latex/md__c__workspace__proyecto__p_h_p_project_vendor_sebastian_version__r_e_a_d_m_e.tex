{\bfseries{Version}} is a library that helps with managing the version number of Git-\/hosted PHP projects.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_sebastian_version__r_e_a_d_m_e_autotoc_md1188}{}\doxysection{Installation}\label{md__c__workspace__proyecto__p_h_p_project_vendor_sebastian_version__r_e_a_d_m_e_autotoc_md1188}
...
\end{DoxyVerb}
 \hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_sebastian_version__r_e_a_d_m_e_autotoc_md1189}{}\doxysection{Usage}\label{md__c__workspace__proyecto__p_h_p_project_vendor_sebastian_version__r_e_a_d_m_e_autotoc_md1189}
...
\end{DoxyVerb}
 When a new release is prepared, the string that is passed to the constructor as the first argument needs to be updated.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_sebastian_version__r_e_a_d_m_e_autotoc_md1190}{}\doxysubsection{How Sebastian\+Bergmann\textbackslash{}\+Version\+::get\+Version() works}\label{md__c__workspace__proyecto__p_h_p_project_vendor_sebastian_version__r_e_a_d_m_e_autotoc_md1190}
