...
\href{https://github.com/nikic/PHP-Parser/tree/3.x/doc}{\texttt{ Documentation for version 3.\+x}} (unsupported; for running on PHP \texorpdfstring{$>$}{>}= 5.\+5; for parsing PHP 5.\+2 to PHP 7.\+2).\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_nikic_php_parser__r_e_a_d_m_e_autotoc_md232}{}\doxysection{Features}\label{md__c__workspace__proyecto__p_h_p_project_vendor_nikic_php_parser__r_e_a_d_m_e_autotoc_md232}
...
\end{DoxyItemize}\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_nikic_php_parser__r_e_a_d_m_e_autotoc_md233}{}\doxysection{Quick Start}\label{md__c__workspace__proyecto__p_h_p_project_vendor_nikic_php_parser__r_e_a_d_m_e_autotoc_md233}
...
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{_unnecessary_string_concat_unit_test_8inc_a7949acdaecc70b9f035c12a7069db132}{\$code}} = <<<\textcolor{stringliteral}{'CODE'}}
\DoxyCodeLine{<?php}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{function} \mbox{\hyperlink{_disallow_long_array_syntax_unit_test_82_8inc_ad69dd4607977cae05ebe19d1ae604fb1}{test}}(\mbox{\hyperlink{_array_indent_unit_test_8inc_a6ceee758c52866f8a4a01904f7acff26}{\$foo}})}
\DoxyCodeLine{\{}
\DoxyCodeLine{    var\_dump(\mbox{\hyperlink{_array_indent_unit_test_8inc_a6ceee758c52866f8a4a01904f7acff26}{\$foo}});}
\DoxyCodeLine{\}}
\DoxyCodeLine{CODE;}
\DoxyCodeLine{}
\DoxyCodeLine{\$parser = (\textcolor{keyword}{new} ParserFactory)-\/>create(ParserFactory::PREFER\_PHP7);}
\DoxyCodeLine{\textcolor{keywordflow}{try} \{}
\DoxyCodeLine{    \$ast = \$parser-\/>parse(\mbox{\hyperlink{_unnecessary_string_concat_unit_test_8inc_a7949acdaecc70b9f035c12a7069db132}{\$code}});}
\DoxyCodeLine{\} \textcolor{keywordflow}{catch} (Error \mbox{\hyperlink{_multiple_statement_alignment_unit_test_8inc_aeba2ab722cedda53dbb7ec1a59f45550}{\$error}}) \{}
...
For a more comprehensive introduction, see the documentation.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_nikic_php_parser__r_e_a_d_m_e_autotoc_md234}{}\doxysection{Documentation}\label{md__c__workspace__proyecto__p_h_p_project_vendor_nikic_php_parser__r_e_a_d_m_e_autotoc_md234}
