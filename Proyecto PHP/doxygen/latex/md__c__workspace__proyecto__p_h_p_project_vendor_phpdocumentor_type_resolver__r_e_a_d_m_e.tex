\href{https://opensource.org/licenses/MIT}{\texttt{ }}  \href{https://coveralls.io/github/phpDocumentor/TypeResolver?branch=1.x}{\texttt{ }} \href{https://scrutinizer-ci.com/g/phpDocumentor/TypeResolver/?branch=1.x}{\texttt{ }} \href{https://scrutinizer-ci.com/g/phpDocumentor/TypeResolver/?branch=1.x}{\texttt{ }}  \hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md348}{}\doxysection{Type\+Resolver and Fqsen\+Resolver}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md348}
...
\end{DoxyEnumerate}\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md349}{}\doxysubsection{Installing}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md349}
...
\end{DoxyVerb}
 \hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md350}{}\doxysubsection{Examples}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md350}
Ready to dive in and don\textquotesingle{}t want to read through all that text below? Just consult the \mbox{[}examples\mbox{]}(examples) folder and check which type of action that your want to accomplish.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md351}{}\doxysubsection{On Types and Element Names}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md351}
...
\item Function expressions (i.\+e. {\ttfamily @see \textbackslash{}My\+Namespace\textbackslash{}\mbox{\hyperlink{_non_executable_code_unit_test_81_8inc_a06571377f104974c15119a898991e2c5}{my\+Function()}}})
\item Class expressions (i.\+e. {\ttfamily @see \textbackslash{}My\+Namespace\textbackslash{}\mbox{\hyperlink{class_my_class}{My\+Class}}})
\item Interface expressions (i.\+e. {\ttfamily @see \textbackslash{}My\+Namespace\textbackslash{}\mbox{\hyperlink{interface_my_interface}{My\+Interface}}})
...
\item Property expressions (i.\+e. {\ttfamily @see \textbackslash{}My\+Namespace\textbackslash{}\mbox{\hyperlink{class_my_class}{My\+Class}}\+:\+:\$my\+Property})
\item Method expressions (i.\+e. {\ttfamily @see \textbackslash{}My\+Namespace\textbackslash{}My\+Class\+::my\+Method()})
\end{DoxyItemize}\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md352}{}\doxysubsection{Resolving a type}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md352}
...
The real power of this resolver is in its capability to expand partial class names into fully qualified class names; but in order to do that we need an additional {\ttfamily \textbackslash{}php\+Documentor\textbackslash{}Reflection\textbackslash{}Types\textbackslash{}Context} class that will inform the resolver in which namespace the given expression occurs and which namespace aliases (or imports) apply.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md353}{}\doxysubsubsection{Resolving nullable types}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md353}
Php 7.\+1 introduced nullable types e.\+g. {\ttfamily ?string}. Type resolver will resolve the original type without the nullable notation {\ttfamily ?} just like it would do without the {\ttfamily ?}. After that the type is wrapped in a {\ttfamily \textbackslash{}php\+Documentor\textbackslash{}Reflection\textbackslash{}Types\textbackslash{}Nullable} object. The {\ttfamily Nullable} type has a method to fetch the actual type.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md354}{}\doxysubsection{Resolving an FQSEN}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md354}
\mbox{\hyperlink{class_a}{A}} Fully Qualified Structural Element Name is a reference to another element in your code bases and can be resolved using the {\ttfamily \textbackslash{}php\+Documentor\textbackslash{}Reflection\textbackslash{}Fqsen\+Resolver} class\textquotesingle{} {\ttfamily resolve} method, like this\+:
...
The real power of this resolver is in its capability to expand partial element names into Fully Qualified Structural Element Names; but in order to do that we need an additional {\ttfamily \textbackslash{}php\+Documentor\textbackslash{}Reflection\textbackslash{}Types\textbackslash{}Context} class that will inform the resolver in which namespace the given expression occurs and which namespace aliases (or imports) apply.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md355}{}\doxysubsection{Resolving partial Classes and Structural Element Names}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md355}
...
\DoxyCodeLine{\{}
\DoxyCodeLine{    \textcolor{keyword}{public} \textcolor{keyword}{function} \mbox{\hyperlink{_camel_caps_function_name_unit_test_8inc_a095c5d389db211932136b53f25f39685}{\_\_construct}}(\$context) \{\}}
\DoxyCodeLine{    }
...
For the resolvers to know how to expand partial names you have to provide a bit of {\itshape Context} for them by instantiating a new class named {\ttfamily \textbackslash{}php\+Documentor\textbackslash{}Reflection\textbackslash{}Types\textbackslash{}Context} with the name of the namespace and the aliases that are in play.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md356}{}\doxysubsubsection{Creating a Context}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md356}
...
\end{DoxyCode}
\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md357}{}\doxysubsubsection{Using the Context}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phpdocumentor_type_resolver__r_e_a_d_m_e_autotoc_md357}
...
Because Classy is a Class in the current namespace its FQSEN will have the {\ttfamily My\textbackslash{}\mbox{\hyperlink{class_example}{Example}}} namespace and by calling the {\ttfamily resolve} method of the FQSEN Resolver you will receive an {\ttfamily Fqsen} object that refers to {\ttfamily \textbackslash{}My\textbackslash{}\mbox{\hyperlink{class_example}{Example}}\textbackslash{}Classy\+::other\+Function()}. 