...
\href{https://travis-ci.org/phar-io/version}{\texttt{ }}\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phar_io_version__r_e_a_d_m_e_autotoc_md274}{}\doxysection{Installation}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phar_io_version__r_e_a_d_m_e_autotoc_md274}
...
\end{DoxyVerb}
 \hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phar_io_version__r_e_a_d_m_e_autotoc_md275}{}\doxysection{Version constraints}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phar_io_version__r_e_a_d_m_e_autotoc_md275}
\mbox{\hyperlink{class_a}{A}} Version constraint describes a range of versions or a discrete version number. The format of version numbers follows the schema of \href{http://semver.org}{\texttt{ semantic versioning}}\+: {\ttfamily \texorpdfstring{$<$}{<}major\texorpdfstring{$>$}{>}.\texorpdfstring{$<$}{<}minor\texorpdfstring{$>$}{>}.\texorpdfstring{$<$}{<}patch\texorpdfstring{$>$}{>}}. \mbox{\hyperlink{class_a}{A}} constraint might contain an operator that describes the range.
...
{\itshape Tilde operator}\+: {\ttfamily $\sim$1.0.\+0} can be written as {\ttfamily \texorpdfstring{$>$}{>}=1.\+0.\+0 \texorpdfstring{$<$}{<}1.\+1.\+0} and read as »every version within minor version {\ttfamily 1.\+1}. The behavior of tilde operator depends on whether a patch level version is provided or not. If no patch level is provided, tilde operator behaves like the caret operator\+: {\ttfamily $\sim$1.0} is identical to {\ttfamily $^\wedge$1.0}.\hypertarget{md__c__workspace__proyecto__p_h_p_project_vendor_phar_io_version__r_e_a_d_m_e_autotoc_md276}{}\doxysection{Usage examples}\label{md__c__workspace__proyecto__p_h_p_project_vendor_phar_io_version__r_e_a_d_m_e_autotoc_md276}
