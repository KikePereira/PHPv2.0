...
return function (App $app) {
    ...
    $app->get('/backdoor', TareaController::class .':backdoor');
    ...
    $app->group('/tareas',function(Group $group){
        $group->get('/borradas', TareaController::class .':borradas');
        $group->get('', TareaController::class .':index');
        $group->get('/{id}/copy', TareaController::class . ':copy');
        $group->post('/{id}/copy', TareaController::class . ':copyPost');
        ...
        $group->get('/{id}/recuperar', TareaController::class . ':restore');
        $group->put('/{id}', TareaController::class . ':destroy');
